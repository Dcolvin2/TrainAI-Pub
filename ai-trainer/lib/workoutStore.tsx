...
export function useWorkoutStore() {
  ...
  return {
    ...state,
    setActive: (active: WorkoutData | null) => dispatch({ type: 'SET_ACTIVE', payload: active }),
    setPending: (pending: WorkoutData | null) => dispatch({ type: 'SET_PENDING', payload: pending }),
    setTimeAvailable: (time: number) => dispatch({ type: 'SET_TIME_AVAILABLE', payload: time }),
